...
# 1、请在脚本中修改你期望优选 IP 的带宽大小（默认160M）

# 2、请更改 426 行 的 xxxxxxxxxx 字符串，为你自己 PassWall 的节点值（不会请看视频教程或是博客）
...
green "=========================================================="
green "=========================================================="
 red  "请在脚本中修改你期望优选 IP 的带宽大小（默认160M）脚本自动运行中....."
 red  "脚本第43行 bandwidth 后面的数值为期望优选带宽大小（ Mbps ）  "
green "=========================================================="
 blue "脚本41行，定义微信pushplus token，自行搜索如何获取token, pushplus地址https://www.pushplus.plus/"
 blue "脚本426行，完成后发送微信推送"
green "=================脚本正在运行中.....======================="
sleep 8s
